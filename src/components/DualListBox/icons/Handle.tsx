...
export default function DragHandle({ isSelected = false }: DragHandleProps) {
  return (
    <svg
      className="opacity-0 group-hover/dual-list-box-item:opacity-100"
      fill="none"
      width="24"
      height="24"
      viewBox="0 0 24 24"
    ...
    >
      <path
        ...
        className={
          isSelected
            ? 'stroke-icon-on-fill-action-pressed'
