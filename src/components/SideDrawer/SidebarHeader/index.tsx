...
export interface SidebarHeaderProps {
  ...
  collapsedStateLogo?: JSX.Element;
  customSidebarHeader?: JSX.Element;
  divider?: DividerType;
}
export function SidebarHeader({
  ...
  return (
    <>
      <div
        className={`${className || ''} ${isSidebarExpanded ? 'pl-6' : '!justify-center pl-4'}  flex h-[4.5rem] w-full items-center justify-between  pr-4`}
      >
        {customSidebarHeader || (
          <>
            <div>{isSidebarExpanded ? logo : collapsedStateLogo}</div>
            {showExpandButton && (
              <div>
                <button
                  type="button"
